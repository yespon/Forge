...
class TestDocsSite:
    def test_001_website_exists(self): assert Path("website").exists()
    def test_002_package_json_exists(self): assert Path("website/package.json").exists()
    def test_003_config_exists(self): assert Path("website/docusaurus.config.ts").exists()
    def test_004_sidebars_exists(self): assert Path("website/sidebars.ts").exists()
    def test_005_homepage_exists(self): assert Path("website/src/pages/index.tsx").exists()
    def test_006_docs_index_exists(self): assert Path("website/docs/index.md").exists()
    def test_007_architecture_doc_imported(self): assert Path("website/docs/architecture.md").exists()
    def test_008_roadmap_doc_imported(self): assert Path("website/docs/roadmap.md").exists()
    def test_009_model_configs_doc_imported(self): assert Path("website/docs/model-configs.md").exists()
    def test_010_docs_readme_exists(self): assert Path("website/README.md").exists()
    def test_011_api_overview_exists(self): assert Path("website/docs/api/overview.md").exists()
    def test_012_api_models_exists(self): assert Path("website/docs/api/models.md").exists()
    def test_013_api_approvals_exists(self): assert Path("website/docs/api/approvals.md").exists()
    def test_014_api_tasks_exists(self): assert Path("website/docs/api/tasks.md").exists()
    def test_015_deployment_doc_exists(self): assert Path("website/docs/deployment/docker.md").exists()
    def test_016_custom_css_exists(self): assert Path("website/src/css/custom.css").exists()
    def test_017_static_img_dir_exists(self): assert Path("website/static/img").exists()
    def test_018_favicon_exists(self): assert Path("website/static/img/favicon.ico").exists()
